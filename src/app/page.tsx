        ...
        <div className='my-14'>
          <div className='grid justify-center'>
            ...
            <div className='md:flex justify-evenly w-screen max-w-[1920px] my-2 max-md:grid max-md:grid-cols-2'>
              ...
              <div className="max-md:mt-3">
                <div className="max-md:flex max-md:justify-center">
                  <img className='w-16 h-16 mx-6' src={ang.src} alt="Angular" />
                </div>
                <p className="text-center quando text-base text-[#9e7653]">Angular</p>
              </div>
            </div>

            <p className="text-[#9e7653] mt-6 text-xl text-center quando">Practicing</p>
            <div className='md:flex justify-evenly w-screen max-w-[1920px] my-2 max-md:grid max-md:grid-cols-2'>
              <div className="max-md:mt-3">
                <div className="max-md:flex max-md:justify-center">
                  <img className='w-16 h-16 mx-6' src={php.src} alt="PHP" />
                </div>
                <p className="text-center quando text-base text-[#9e7653]">PHP</p>
              </div>
              <div className="max-md:mt-3">
                <div className="max-md:flex max-md:justify-center">
                  <img className='w-16 h-16 mx-6' src={python.src} alt="Python" />
                </div>
                <p className="text-center quando text-base text-[#9e7653]">Python</p>
              </div>
              <div className="max-md:mt-3">
                <div className="max-md:flex max-md:justify-center">
                  <img className='w-16 h-16 mx-6' src={ssqqll.src} alt="SQL" />
                </div>
                <p className="text-center quando text-base text-[#9e7653]">SQL</p>
              </div>
            </div>
            ...
            <div className='md:flex justify-evenly w-screen max-w-[1920px] my-2 max-md:grid max-md:grid-cols-2'>
              <div className="max-md:mt-3">
                <div className="max-md:flex max-md:justify-center">
                  <img className='w-16 h-16 mx-6' src={sqlite.src} alt="SQLite" />
                </div>
                <p className="text-center quando text-base text-[#9e7653]">SQLite</p>
              </div>
              <div className="max-md:mt-3">
                <div className="max-md:flex max-md:justify-center">
            ...
            <div className='md:flex justify-evenly w-screen max-w-[1920px] my-2 max-md:grid max-md:grid-cols-2'>
              <div className="max-md:mt-3">
                <div className="max-md:flex max-md:justify-center">
                  <img className='w-16 h-16 mx-6' src={post.src} alt="Postman" />
                </div>
                <p className="text-center quando text-base text-[#9e7653]">Postman</p>
              </div>
              <div className="max-md:mt-3">
                <div className="max-md:flex max-md:justify-center">
                  <img className='w-16 h-16 mx-6' src={slack.src} alt="Slack" />
                </div>
                <p className="text-center quando text-base text-[#9e7653]">Slack</p>
              </div>
              <div className="max-md:mt-3">
                <div className="max-md:flex max-md:justify-center">
                  <img className='w-16 h-16 mx-6 p-1' src={notion.src} alt="Notion" />
                </div>
                <p className="text-center quando text-base text-[#9e7653]">Notion</p>
              </div>
              <div className="max-md:mt-3">
                <div className="max-md:flex max-md:justify-center">
                  <img className='w-16 h-16 mx-6' src={jira.src} alt="Jira" />
                </div>
                <p className="text-center quando text-base text-[#9e7653]">Jira</p>
              </div>
              <div className="max-md:mt-3">
                <div className="max-md:flex max-md:justify-center">
                  <img className='w-16 h-16 mx-6' src={devops.src} alt="Azure DevOps" />
                </div>
                <p className="text-center quando text-base text-[#9e7653]">Azure DevOps</p>
              </div>
            </div>
